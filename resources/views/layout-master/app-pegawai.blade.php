...
<div id="main-wrapper">
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a href="{{route('home-pegawai')}}" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a></li>
    ...
    @yield('content')
    <!-- footer -->
    <footer class="footer"> Copyright &copy; {{date(now()->format('Y'))}} Quali International Surabaya. All&nbsp;Rights&nbsp;Reserved. <b>QIS OFFICE</b></footer>
    <!-- End footer -->
</div>
<!-- End Wrapper -->
<!-- All Jquery -->
