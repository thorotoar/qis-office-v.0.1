...
@section('title', 'QIS ADMIN | RESET PASSWORD')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">QIS ADMIN</h3> </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Change Password</a></li>
                    <li class="breadcrumb-item active">QIS ADMIN</li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="{{route('ua-pass')}}" method="post">
                                    {{csrf_field()}}
