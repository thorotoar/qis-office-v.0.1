<div class="modal" id="modalTransportasi" tabindex="1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h5 class="h5-responsive">
                                    <small class="green-text">Nama Transportasi :</small><br>
                                    <strong id="namaTran"></strong>
                                </h5>
                            </div>
                            <div class="col-md-4">
                                <h5 class="h5-responsive">
