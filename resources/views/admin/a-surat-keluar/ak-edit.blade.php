...
@section('title', 'QIS ADMIN | EDIT SURAT KELUAR')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-elements">
                                    <form action="{{route('a-surk-update', $sk->id)}}" enctype="multipart/form-data" method="post">
                                        {{csrf_field()}}
                                        ...
                                        <hr><div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <a href="{{route('a-surk-home')}}" class="btn btn-dark">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
