...
@section('title', 'QIS ADMIN | EDIT DATA PEGAWAI')
...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-elements">
                                <form action="{{route('ad-u-pegawai', $pegawai)}}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    {{--Personal Info--}}
                                    <div class="row">
                                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                ...
                                                <a href="{{route('ad-pegawai')}}" class="btn btn-dark">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        $('#lembaga').on('change', function(e){
            ...
            $.get('/admin/data-pegawai/jabatan?lembaga_id=' + lembaga_id,function(data) {
                console.log(data);
                $('#jabatan').empty();
