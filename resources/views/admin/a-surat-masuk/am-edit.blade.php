...
@section('title', 'QIS ADMIN | EDIT SURAT MASUK')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-elements">
                                <form action="{{route('a-surm-update', $suratM->id)}}" enctype="multipart/form-data" method="post">
                                    {{csrf_field()}}
                                    {{--surat masuk--}}
                                    <div class="row">
                                        <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                ...
                                                <a href="{{route('a-surm-home')}}" class="btn btn-dark">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
