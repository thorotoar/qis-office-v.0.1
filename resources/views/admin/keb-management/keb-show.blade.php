<div class="modal" id="modalKebutuhan" tabindex="1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h5 class="h5-responsive">
                                    <small class="green-text">Kode Kebutuhan :</small><br>
                                    <strong id="kodeKeb"></strong>
                                </h5>
                            </div>
                            <div class="col-md-3">
                                <h5 class="h5-responsive">
                                    <small class="green-text">Nama Kebutuhan :</small><br>
                                    <strong id="namaKeb"></strong>
                                </h5>
                            </div>
                            <div class="col-md-3">
                                <h5 class="h5-responsive">
