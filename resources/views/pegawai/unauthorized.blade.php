...
<head>
    ...
    <title>QIS Pegawai | Pengalihan</title>
    <!-- Bootstrap Core CSS -->
...
<div class="error-page" id="wrapper">
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <a class="btn btn-info btn-rounded waves-effect waves-light m-b-40" href="{{route('home-pegawai')}}">Kembali ke halaman '{{$role}}' </a> </div>
