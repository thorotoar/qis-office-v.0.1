                                        ...
                                        @if($jenis->template_surat == 'Template 1')
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Tujuan </label>
                                                        <input class="form-control input-sm" type="Text" placeholder="Contoh: Bagian Keuangan/ Sdr. Abdullah" name="tujuan">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tempat Tujuan </label>
                                                        <input class="form-control input-sm" type="Text" placeholder="Contoh: SIKES MUHAMMADIYAH LAMONGAN" name="tempat_tujuan">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control input-sm" type="Text" placeholder="Contoh: Lamongan" name="kota_tujuan">
                                                    </div>
                                                </div>
                                            </div>
