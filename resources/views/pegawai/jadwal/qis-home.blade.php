...
@section('title', 'QIS OFFICE | JADWAL PELAJARAN QIS ENGLISH')
...
@section('content')
    ...
    <script>
        ...
        function getJadwalQIS() {
            swal({
                title: "Tambahkan Jadwal Peserta Didik ?",
                text: "Data jadwal QIS English akan ditambahkan !!",
                type: "warning",
                ...
                if (isConfirm) {
                    window.location = '{{route('get.jadwal.qis')}}';
                }
            });
