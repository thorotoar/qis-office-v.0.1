...
@section('title', 'QIS OFFICE | JADWAL PELAJARAN SANGGAR ABK')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Jadwal Pelajaran Sanggar ABK</h3> </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Jadwal Pelajaran Sanggar ABK</li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
        ...
        <!-- Start Page Content -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Daftar Jadwal Pelajaran Sanggar ABK</h4><hr>
                            <div class="button-list">
                                {{--<a class="btn btn-primary btn-flat" href="{{route('surm-tambah')}}">--}}
                                {{--<i class="fa fa-plus"></i>&nbsp;Tambah Jadwal</a>--}}
                                <button href="javascript:void(0)" class="btn btn-primary btn-flat" onclick="getJadwalABK()"><i
                                            class="fa fa-refresh"></i>&nbsp;Tambah Jadwal</button>
                                <a class="btn btn-primary btn-flat" href="{{route('j-print-all', ['id' => 4])}}">
    ...
    <script>
        ...
        function getJadwalABK() {
            swal({
                ...
                if (isConfirm) {
                    window.location = '{{route('get.jadwal.abk')}}';
                }
            });
